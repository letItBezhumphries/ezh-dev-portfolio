            ...
            <ul className="social-links list-inline">
              <li className="list-link">
                <a href="https://www.linkedin.com/in/eric-humphries-80">
                  <FontAwesomeIcon icon={faLinkedinIn} size="xl" className="item-icon" />
                </a>
              </li>
              <li className="list-link">
                <a href="https://www.github.com/letItBezhumphries">
                  <FontAwesomeIcon icon={faGithub} size="xl" className="item-icon" />
                </a>
              </li>
              <li className="list-link">
                <a href="https://www.facebook.com/ericzhumphries">
                  <FontAwesomeIcon icon={faFacebook} size="xl" className="item-icon" />
                </a>
              </li>
              <li className="list-link last">
                <a href="https://www.twitter.com/erichumphries">
                  <FontAwesomeIcon icon={faTwitter} size="xl" className="item-icon" />
                </a>
              </li>
            </ul>
          </div>
          <div className="header-right">
            <a href="mailto:email@ezhumphries@gmail.com" className="btn btn-info">
              <span>
