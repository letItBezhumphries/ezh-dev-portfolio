    ...
    <section className='skills-section'>
      <div className='section-inner'>
        ...
        <div className='section-content'>
          <p className='intro'>
            While most of my experience is in Web Development utilizing
            JavaScript, I also have experience working with DevOps /
            infrastructure building technologies like Terraform, Packer,
            Ansible, Docker
          </p>
          <div className='skillset'>
            <div className='skill'>
              <h3 className='skill__title'>
                ...
                <SkillTooltip
                  title='I have over 4 years experience in JS and Node including utilizing it while having taken Hack Reactor the top coding Bootcamp in the US.'
                  id='javascript-skill'
                >
                  <FontAwesomeIcon
                    icon={faCircleInfo}
            ...
            <div className='skill'>
              <h3 className='skill__title'>
                <span>AWS</span>
                <SkillTooltip
                  title='I have 3 years experience deploying application code on Amazon ec2 and ecs services.'
                  id='aws-skill'
                >
                  <FontAwesomeIcon
                    icon={faCircleInfo}
            ...
            <div className='skill last-link'>
              <a
                ...
                href='https://linkedin.com/in/eric-humphries-80'
              >
                <FontAwesomeIcon
                  icon={faUpRightFromSquare}
                  size='lg'
                  className='more-link-icon'
                />
                More on Linkedin
              </a>
            </div>
